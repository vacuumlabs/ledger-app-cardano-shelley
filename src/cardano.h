...
typedef enum {
	...
	CERTIFICATE_TYPE_STAKE_REG = 7,
	CERTIFICATE_TYPE_STAKE_UNREG = 8,
	CERTIFICATE_TYPE_VOTE_DELEG = 9,
	CERTIFICATE_TYPE_COMMITTEE_AUTH = 14,
	CERTIFICATE_TYPE_COMMITTEE_RESIGN = 15,
	CERTIFICATE_TYPE_DREP_REG = 16,
	CERTIFICATE_TYPE_DREP_UNREG = 17,
	CERTIFICATE_TYPE_DREP_UPDATE = 18,
} certificate_type_t;
