...
void test_CIP15()
{
	PRINTF("governance voting CIP15\n");
	...
	auxDataHashBuilder_governanceVotingRegistration_enter(&builder, CIP15);
...
void test_CIP36()
{
	PRINTF("governance voting CIP36\n");
	...
	static const char* expectedGovernanceVotingRegistrationPayloadHashHex = "5bc0681f173efd76e1989037a3694b8a7abea22053f5940cbb5cfcdf721007d7";
	static const char* expectedAuxDataHashHex = "3786b3ad677129e43dbb3456e45e5af589e9aae81062ef7e26f15fde00df421d";

	aux_data_hash_builder_t builder;

	auxDataHashBuilder_init(&builder);
	auxDataHashBuilder_governanceVotingRegistration_enter(&builder, CIP36);
	auxDataHashBuilder_governanceVotingRegistration_enterPayload(&builder);

	auxDataHashBuilder_governanceVotingRegistration_enterDelegations(&builder, 2);
	{
		uint8_t tmp[32] = {0};
	...
	auxDataHashBuilder_governanceVotingRegistration_addNonce(&builder, nonce);
	auxDataHashBuilder_governanceVotingRegistration_addVotingPurpose(&builder, votingPurpose);
