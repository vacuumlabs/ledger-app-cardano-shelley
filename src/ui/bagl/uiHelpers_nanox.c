...
UX_FLOW(ux_short_text_flow, &ux_display_short_text_flow_1_step);
...
UX_STEP_CB(ux_display_prompt_flow_1_step,
           pbb,
           prompt_confirm(),
...
UX_STEP_CB(ux_display_prompt_flow_2_step,
           pbb,
           prompt_reject(),
           LINES(&C_icon_crossmark, "Reject?", ""));

UX_FLOW(ux_prompt_flow, &ux_display_prompt_flow_1_step, &ux_display_prompt_flow_2_step);
