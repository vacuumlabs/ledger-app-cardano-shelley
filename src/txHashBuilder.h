...
void txHashBuilder_enterCertificates(tx_hash_builder_t* builder, uint16_t numCertificates);
...
void txHashBuilder_enterWithdrawals(tx_hash_builder_t* builder, uint16_t numWithdrawals);
