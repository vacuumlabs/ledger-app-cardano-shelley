...
typedef enum {
	...
	AUX_DATA_HASH_BUILDER_IN_CATALYST_REGISTRATION_PAYLOAD_INIT = 210,
	AUX_DATA_HASH_BUILDER_IN_CATALYST_REGISTRATION_PAYLOAD_VOTING_KEY = 211,
	AUX_DATA_HASH_BUILDER_IN_CATALYST_REGISTRATION_PAYLOAD_STAKING_KEY = 212,
	AUX_DATA_HASH_BUILDER_IN_CATALYST_REGISTRATION_PAYLOAD_VOTING_REWARDS_ADDRESS = 213,
	AUX_DATA_HASH_BUILDER_IN_CATALYST_REGISTRATION_PAYLOAD_NONCE = 214,
	AUX_DATA_HASH_BUILDER_IN_CATALYST_REGISTRATION_SIGNATURE = 220,
