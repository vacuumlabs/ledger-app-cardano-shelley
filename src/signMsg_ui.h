...
enum {
	...
	HANDLE_INIT_ADDRESS_FIELD_DISPLAY_KEY_HASH,
	HANDLE_INIT_ADDRESS_FIELD_DISPLAY_ADDRESS,
	HANDLE_INIT_ADDRESS_FIELD_DISPLAY_SPENDING_PATH,
	HANDLE_INIT_ADDRESS_FIELD_DISPLAY_STAKING_INFO,
	HANDLE_INIT_RESPOND,
	HANDLE_INIT_INVALID,
};
