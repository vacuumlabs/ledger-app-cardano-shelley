...
transactionInitRejectTestCases: List[SignTxTestCase] = [
    ...
    SignTxTestCase("Ordinary tx - collateral collateral included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   SignedTransactionData(sw=Errors.SW_REJECTED_BY_POLICY)),
    SignTxTestCase("Multisig tx - collateral collateral included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   SignedTransactionData(sw=Errors.SW_REJECTED_BY_POLICY)),
    SignTxTestCase("Pool registration (operator) - collateral collateral included",
                   Transaction(Mainnet,
                               [inputs["utxoShelley"]],
                               [outputs["externalByronMainnet"]],
                               42,
                   ...
                   "",
                   SignedTransactionData(sw=Errors.SW_REJECTED_BY_POLICY)),
    SignTxTestCase("Pool registration (owner) - collateral collateral included",
                   Transaction(Mainnet,
                               [inputs["utxoMultisig"]],
                               [outputs["externalByronMainnet"]],
                               42,
